...
function TrailerPlayer({ videoKey, onClose }) {
  ...
  return (
    <div className='w-screen h-screen bg-black/[0.7] flex items-start justify-center  fixed top-0 left-0 z-50'>
      <div ref={trailerRef} className='trailer h-[40%] flex items-center justify-center w-full lg:w-[80%] lg:h-[80%] bg-black mt-10 lg-mt-0'>
        <button onClick={onClose} className="absolute lg:top-0 top-[-40px] right-0 p-4 text-white cursor-pointer"><MdClose/></button>
        <iframe
          title='Trailer'
          width='100%'
          height='85%'
