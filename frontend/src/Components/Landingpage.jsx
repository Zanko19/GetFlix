  ...
  return (
    <div className="containermain w-screen h-auto lg:h-screen flex flex-col lg:flex-row items-center my-5 lg:mb-5 lg:mt-5">
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <section className={`lg:absolute h-auto w-full lg:left-[20vw] lg:bottom-0 lg:w-[80vw] lg:h-[85vh] text-white text-3xl flex flex-col lg:flex lg:flex-row items-center justify-center lg:items-start lg:justify-between ${isOpen ? 'bg-white/0.5' : ''}`}>
