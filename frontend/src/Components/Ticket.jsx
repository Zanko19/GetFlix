        ...
        {movie && (
          <>
            ...
            <section className="flex flex-col w-[30%] h-[94%] justify-between mr-10 hidden lg:flex">
              <div className=" lglass  h-[30%] w-full rounded-3xl flex flex-row items-center" style={{ background: 'radial-gradient(circle, rgba(0, 0, 128, 0.3), transparent)' }}>
              ...
              <div className=" lglass  h-[30%] w-full rounded-3xl flex flex-row items-center" style={{ background: 'radial-gradient(circle, rgba(128, 0, 128, 0.3), transparent)' }}>
                <div className="h-[100%] w-[40%]">
                  <img
                    className="h-full z-50"
                    src={pop}
              ...
              <div className=" lglass  h-[30%] w-full rounded-3xl flex flex-row items-center" style={{ background: 'radial-gradient(circle, rgba(40, 167, 69, 0.3), transparent)' }}>
                <div className="h-[100%] w-[40%]">
                  <img
                    className="h-full z-50"
                    src={bol}
